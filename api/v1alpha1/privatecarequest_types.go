...
type PrivateCARequestSpec struct {
...
type PrivateCARequestStatus struct {
...
type PrivateCARequest struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   PrivateCARequestSpec   `json:"spec,omitempty"`
	Status PrivateCARequestStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// PrivateCARequestList contains a list of PrivateCARequest
type PrivateCARequestList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []PrivateCARequest `json:"items"`
}

func init() {
	SchemeBuilder.Register(&PrivateCARequest{}, &PrivateCARequestList{})
}
